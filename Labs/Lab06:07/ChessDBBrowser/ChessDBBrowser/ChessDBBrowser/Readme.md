...
### ChessDBBrowser.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [ChessDBBrowser.Sample.csproj](../ChessDBBrowser.Sample/ChessDBBrowser.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### ChessDBBrowser.Tests
