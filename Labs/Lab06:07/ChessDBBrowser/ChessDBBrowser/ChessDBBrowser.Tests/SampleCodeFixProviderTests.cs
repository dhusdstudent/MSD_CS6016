...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<ChessDBBrowser.SampleSyntaxAnalyzer,
        ChessDBBrowser.SampleCodeFixProvider>;

namespace ChessDBBrowser.Tests;
